...
if (
    ...
    if (!hash_equals($_SESSION['csrf_token'], $_POST['csrf_token'] ?? '')) {
        $reg_error = "Lỗi bảo mật, vui lòng thử lại.";
    } else {
...
<body class="bg-light d-flex justify-content-center align-items-center" style="min-height: 100vh;">
    <div class="card p-4 shadow" style="width: 100%; max-width: 450px;">
        ...
        <form method="POST">
            ...
            <div class="mb-3">
                <input type="email" name="reg_email" class="form-control" placeholder="Email" value="<?= htmlspecialchars($email) ?>" required>
            </div>
            <div class="mb-3">
                <input type="text" name="reg_name" class="form-control" placeholder="Tên hiển thị" value="<?= htmlspecialchars($name) ?>" required>
            </div>
            <div class="mb-3">
